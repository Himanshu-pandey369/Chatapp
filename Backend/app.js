...
const io = new Server(server, {
  cors: {
    origin: [
      "http://localhost:5173",
      "https://chatapp-one-indol.vercel.app",
      "https://chatapp-gf86.onrender.com"
    ],
    credentials: true,
  },
});
...
app.use(cors({
  origin: ["http://localhost:5173", "https://chatapp-one-indol.vercel.app", "https://chatapp-gf86.onrender.com"],
  credentials: true,
}));
